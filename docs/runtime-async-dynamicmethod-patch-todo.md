...
| 8 | [ ] | active | Add focused regression coverage for pair lifetime, forced finalization/reuse, failure cleanup, portable entrypoints, profiler lifecycle, runtime gating, and implementation-flag semantics. | CoreCLR and Mono runtime-gating/implementation-flag tests, canonical Core_Root promotion, and MpsAgent compiler consumer validation are complete. Focused lifetime, failure-cleanup, portable-entrypoint, and profiler tests remain. | transaction d21af63ba3b7 |
