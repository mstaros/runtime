...
| 3 | [x] | done | Clear portable-entrypoint pending state for both descriptors before either descriptor is recycled. | Finalization clears pending state for both paired descriptors under `FEATURE_PORTABLE_ENTRYPOINTS`; executable regression coverage remains WASM-only because this feature is not enabled on Windows x64. | c884f441c6f92035e83c9daccb72984883d125c4 |
