...
| 8 | [ ] | active | Add focused regression coverage for pair lifetime, forced finalization/reuse, failure cleanup, portable entrypoints, profiler lifecycle, runtime gating, and implementation-flag semantics. | Runtime gating/flags and consumer validation are complete. Transaction `60ea9962c6ef` adds deterministic forced-finalization/pair-reuse coverage and proves second-descriptor checkout backout. Late-stage construction failures after initialization/publication, portable-entrypoint cleanup, and profiler/ETW lifecycle tests remain. | transactions d21af63ba3b7, 60ea9962c6ef |
