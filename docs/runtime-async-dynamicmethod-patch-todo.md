...
| 8 | [ ] | active | Add focused regression coverage for pair lifetime, forced finalization/reuse, failure cleanup, portable entrypoints, profiler lifecycle, runtime gating, and implementation-flag semantics. | Runtime gating/flags and consumer validation are complete. Transaction `60ea9962c6ef` covers forced-finalization/pair reuse and second-descriptor checkout backout. Transaction `af002a690ee1` covers deterministic unwind after descriptor initialization, first and second long-weak-handle allocation, and reflection-stub allocation. Portable-entrypoint cleanup and profiler/ETW lifecycle tests remain. | transactions d21af63ba3b7, 60ea9962c6ef, af002a690ee1 |
